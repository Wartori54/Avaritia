 ...
 */
public class AvaritiaRecipeManager extends JsonReloadListener {
...
//    private static final Map<ResourceLocation, IRecipeFactory<ICompressorRecipe>> compressorRecipeFactories = new HashMap<>();
    ...
    public AvaritiaRecipeManager() {
        super(GSON, "extreme_recipes");
    }
    ...
    // BIG TODO: RECIPE MANAGEMENT AND LITERALLY EVERYTHING AAAAAAAAAAAAAA
//    private static final ObfMapping mapping = new ObfMapping(//
//            "net/minecraftforge/common/crafting/JsonContext",//
//            "loadConstants",//
//            "([Lcom/google/gson/JsonObject;)V"//
//    );
//    private static final BiConsumer<JsonCont, JsonObject[]> callLoadContext =//
...
//        }
    ...
    private static void loadRecipes(ModContainer mod, String type, TriConsumer<JsonObject, Object, ResourceLocation> loadRecipe) { // Object = JsonContext
//        JsonContext ctx = new JsonContext(mod.getModId());
...
//    private static <T> T getRecipe(JsonObject obj, Object ctx, Function<ResourceLocation, IRecipeFactory<T>> getter) {
...
//        }
    ...
    public static ItemStack getExtremeCraftingResult(CraftingInventory matrix) {
...
//        }
    ...
    public static NonNullList<ItemStack> getRemainingItems(CraftingInventory matrix, World world) {
//        for (IExtremeRecipe recipe : EXTREME_RECIPES.values()) {
