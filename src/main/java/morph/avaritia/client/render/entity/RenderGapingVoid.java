...
//
//public class RenderGapingVoid extends EntityRenderer<EntityGapingVoid> {
//
...
//
//    @Override
//    public void render(EntityGapingVoid ent, float p_225623_2_, float p_225623_3_, MatrixStack stack, IRenderTypeBuffer renderTypeBuffer, int p_225623_6_) {
//
...
//
//    @Override
//    public ResourceLocation getTextureLocation(EntityGapingVoid ent) {
//        return fill;
//    }
//
...
//        RenderSystem.color4f((float) f, (float) f, (float) f, (float) alpha);
//    }
//}
